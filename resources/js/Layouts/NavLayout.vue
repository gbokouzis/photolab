...
<nav class="bg-neutral-50">
  <div class="relative w-full flex h-16">
    ...
    <!-- Right -->
    <div class="flex flex-shrink items-center px-2 sm:px-4 lg:px-8">
      <!-- Upload -->
      <button type="button" class="hidden sm:block p-1 rounded-full hover:bg-gray-300 focus:outline-none focus:ring-1 focus:ring-offset-0.8 focus:ring-offset-neutral-900 focus:ring-neutral-900">
  ...
  <div class="relative w-full flex sm:h-12">
    ...
    <div class="w-full flex justify-center flex-col sm:flex-row items-center  px-6 py-4 shadow-sm  mx-auto">
      <ul class="flex flex-col sm:flex-row md:space-x-5 w-full items-center justify-center md:text-lg">
        <li class="font-semibold tracking-tight block cursor-pointer p-2 
            text-gray-600 hover:text-neutral-900 hover:underline transition-colors duration-300"
        >
            Home
        </li>
        <li class="font-semibold tracking-tight block cursor-pointer p-2 
    ...
    <div class="hidden flex-shrink-0 sm:block">
      <span class="flex items-center justify-end mx-2 sm:mx-4 lg:mx-8">Hi {username}!</span>
    </div>
  </div>
